...
Route::get('/booking/tickets/{slug}', [BookingController::class, 'booking'])->name('front.booking');
Route::post('/booking/tickets', [BookingController::class, 'bookingStore'])->name('front.booking_store');
